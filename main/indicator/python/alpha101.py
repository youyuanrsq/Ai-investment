...
def get_alpha(df, extra_agg_dict):
    stock = Alphas(df)
    df['alpha001'] = stock.alpha001()
    extra_agg_dict['alpha001'] = 'last'
    df['alpha002'] = stock.alpha002()
    extra_agg_dict['alpha002'] = 'last'
    df['alpha003'] = stock.alpha003()
    extra_agg_dict['alpha003'] = 'last'
    df['alpha004'] = stock.alpha004()
    extra_agg_dict['alpha004'] = 'last'
    df['alpha005'] = stock.alpha005()
    extra_agg_dict['alpha005'] = 'last'
    df['alpha006'] = stock.alpha006()
    extra_agg_dict['alpha006'] = 'last'
    df['alpha007'] = stock.alpha007()
    extra_agg_dict['alpha007'] = 'last'
    df['alpha008'] = stock.alpha008()
    extra_agg_dict['alpha008'] = 'last'
    df['alpha009'] = stock.alpha009()
    extra_agg_dict['alpha009'] = 'last'
    df['alpha010'] = stock.alpha010()
    extra_agg_dict['alpha010'] = 'last'
    df['alpha011'] = stock.alpha011()
    extra_agg_dict['alpha011'] = 'last'
    df['alpha012'] = stock.alpha012()
    extra_agg_dict['alpha012'] = 'last'
    df['alpha013'] = stock.alpha013()
    extra_agg_dict['alpha013'] = 'last'
    df['alpha014'] = stock.alpha014()
    extra_agg_dict['alpha014'] = 'last'
    df['alpha015'] = stock.alpha015()
    extra_agg_dict['alpha015'] = 'last'
    df['alpha016'] = stock.alpha016()
    extra_agg_dict['alpha016'] = 'last'
    df['alpha017'] = stock.alpha017()
    extra_agg_dict['alpha017'] = 'last'
    df['alpha018'] = stock.alpha018()
    extra_agg_dict['alpha018'] = 'last'
    df['alpha019'] = stock.alpha019()
    extra_agg_dict['alpha019'] = 'last'
    df['alpha020'] = stock.alpha020()
    extra_agg_dict['alpha020'] = 'last'
    df['alpha021'] = stock.alpha021()
    extra_agg_dict['alpha021'] = 'last'
    df['alpha022'] = stock.alpha022()
    extra_agg_dict['alpha022'] = 'last'
    df['alpha023'] = stock.alpha023()
    extra_agg_dict['alpha023'] = 'last'
    df['alpha024'] = stock.alpha024()
    extra_agg_dict['alpha024'] = 'last'
    df['alpha025'] = stock.alpha025()
    extra_agg_dict['alpha025'] = 'last'
    df['alpha026'] = stock.alpha026()
    extra_agg_dict['alpha026'] = 'last'
    df['alpha027'] = stock.alpha027()
    extra_agg_dict['alpha027'] = 'last'
    df['alpha028'] = stock.alpha028()
    extra_agg_dict['alpha028'] = 'last'
    df['alpha029'] = stock.alpha029()
    extra_agg_dict['alpha029'] = 'last'
    df['alpha030'] = stock.alpha030()
    extra_agg_dict['alpha030'] = 'last'
    df['alpha031'] = stock.alpha031()
    extra_agg_dict['alpha031'] = 'last'
    df['alpha032'] = stock.alpha032()
    extra_agg_dict['alpha032'] = 'last'
    df['alpha033'] = stock.alpha033()
    extra_agg_dict['alpha033'] = 'last'
    df['alpha034'] = stock.alpha034()
    extra_agg_dict['alpha034'] = 'last'
    df['alpha035'] = stock.alpha035()
    extra_agg_dict['alpha035'] = 'last'
    df['alpha036'] = stock.alpha036()
    extra_agg_dict['alpha036'] = 'last'
    df['alpha037'] = stock.alpha037()
    extra_agg_dict['alpha037'] = 'last'
    df['alpha038'] = stock.alpha038()
    extra_agg_dict['alpha038'] = 'last'
    df['alpha039'] = stock.alpha039()
    extra_agg_dict['alpha039'] = 'last'
    df['alpha040'] = stock.alpha040()
    extra_agg_dict['alpha040'] = 'last'
    df['alpha041'] = stock.alpha041()
    extra_agg_dict['alpha041'] = 'last'
    df['alpha042'] = stock.alpha042()
    extra_agg_dict['alpha042'] = 'last'
    df['alpha043'] = stock.alpha043()
    extra_agg_dict['alpha043'] = 'last'
    df['alpha044'] = stock.alpha044()
    extra_agg_dict['alpha044'] = 'last'
    df['alpha045'] = stock.alpha045()
    extra_agg_dict['alpha045'] = 'last'
    df['alpha046'] = stock.alpha046()
    extra_agg_dict['alpha046'] = 'last'
    df['alpha047'] = stock.alpha047()
    extra_agg_dict['alpha047'] = 'last'
    df['alpha049'] = stock.alpha049()
    extra_agg_dict['alpha049'] = 'last'
    df['alpha050'] = stock.alpha050()
    extra_agg_dict['alpha050'] = 'last'
    df['alpha051'] = stock.alpha051()
    extra_agg_dict['alpha051'] = 'last'
    df['alpha052'] = stock.alpha052()
    extra_agg_dict['alpha052'] = 'last'
    df['alpha053'] = stock.alpha053()
    extra_agg_dict['alpha053'] = 'last'
    df['alpha054'] = stock.alpha054()
    extra_agg_dict['alpha054'] = 'last'
    df['alpha055'] = stock.alpha055()
    extra_agg_dict['alpha055'] = 'last'
    df['alpha057'] = stock.alpha057()
    extra_agg_dict['alpha057'] = 'last'
    df['alpha060'] = stock.alpha060()
    extra_agg_dict['alpha060'] = 'last'
    df['alpha061'] = stock.alpha061()
    extra_agg_dict['alpha061'] = 'last'
    df['alpha062'] = stock.alpha062()
    extra_agg_dict['alpha062'] = 'last'
    df['alpha064'] = stock.alpha064()
    extra_agg_dict['alpha064'] = 'last'
    df['alpha065'] = stock.alpha065()
    extra_agg_dict['alpha065'] = 'last'
    df['alpha066'] = stock.alpha066()
    extra_agg_dict['alpha066'] = 'last'
    df['alpha068'] = stock.alpha068()
    extra_agg_dict['alpha068'] = 'last'
    df['alpha071'] = stock.alpha071()
    extra_agg_dict['alpha071'] = 'last'
    df['alpha072'] = stock.alpha072()
    extra_agg_dict['alpha072'] = 'last'
    df['alpha073'] = stock.alpha073()
    extra_agg_dict['alpha073'] = 'last'
    df['alpha074'] = stock.alpha074()
    extra_agg_dict['alpha074'] = 'last'
    df['alpha075'] = stock.alpha075()
    extra_agg_dict['alpha075'] = 'last'
    df['alpha077'] = stock.alpha077()
    extra_agg_dict['alpha077'] = 'last'
    df['alpha078'] = stock.alpha078()
    extra_agg_dict['alpha078'] = 'last'
    df['alpha081'] = stock.alpha081()
    extra_agg_dict['alpha081'] = 'last'
    df['alpha083'] = stock.alpha083()
    extra_agg_dict['alpha083'] = 'last'
    df['alpha084'] = stock.alpha084()
    extra_agg_dict['alpha084'] = 'last'
    df['alpha085'] = stock.alpha085()
    extra_agg_dict['alpha085'] = 'last'
    df['alpha086'] = stock.alpha086()
    extra_agg_dict['alpha086'] = 'last'
    df['alpha088'] = stock.alpha088()
    extra_agg_dict['alpha088'] = 'last'
    df['alpha092'] = stock.alpha092()
    extra_agg_dict['alpha092'] = 'last'
    df['alpha094'] = stock.alpha094()
    extra_agg_dict['alpha094'] = 'last'
    df['alpha095'] = stock.alpha095()
    extra_agg_dict['alpha095'] = 'last'
    df['alpha096'] = stock.alpha096()
    extra_agg_dict['alpha096'] = 'last'

    df['alpha098'] = stock.alpha098()
    extra_agg_dict['alpha098'] = 'last'
    df['alpha099'] = stock.alpha099()
    extra_agg_dict['alpha099'] = 'last'
    df['alpha101'] = stock.alpha101()
    extra_agg_dict['alpha101'] = 'last'
    return df, extra_agg_dict


def get_pos_alpha(df, extra_agg_dict):
    stock = Alphas(df)
    df['alpha001'] = stock.alpha001()
    extra_agg_dict['alpha001'] = 'last'
...
class Alphas(object):
    def __init__(self, df_data):
        ...
        self.returns = df_data['pct_chg'] * 100
        self.vwap = df_data['Value'] / df_data['Volume']
    ...
    # Alpha#63	 ((rank(decay_linear(delta(IndNeutralize(close, IndClass.industry), 2.25164), 8.22237))- rank(
    # decay_linear(correlation(((vwap * 0.318108) + (open * (1 - 0.318108))), sum(adv180,37.2467), 13.557),
    # 12.2883))) * -1)

    # Alpha#64	 ((rank(correlation(sum(((open * 0.178404) + (low * (1 - 0.178404))), 12.7054),sum(adv120, 12.7054),
...
#     end_date = '2021-03-01'
#
#     df = pd.read_csv(allticker_path + '/AAPL.csv', encoding='GBK', index_col=0)
#     df['Ticker'] = 'AAPL'
